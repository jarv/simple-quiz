jQuery ->
  ...
  class CardView extends Backbone.View
    ...
    renderCard: (variables) ->
      ...
      @
    displayCard: ->
      if @model == active_deck.last_selected
        return
      if !active_deck.selected_card && !active_deck.new_card
        $('#front_img_preview').html('')
        $('#back_img_preview').html('')
        $('#front_img_preview').html(@model.get('front_img_full'))
        $('#back_img_preview').html(@model.get('back_img_full'))
        $('#front_input').val(@model.get('front_text'))
        $('#back_input').val(@model.get('back_text'))
